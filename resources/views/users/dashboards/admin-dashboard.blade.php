  ...
  <div class="layout">
    ...
    <main class="main-content">
      ...
      <section class="dashboard-grid">
        ...
        <!-- Row 2 -->
        <div class="card purple"><h3>Month Total</h3><p>₱5,678</p></div>
        <div class="card red"><h3>Saved</h3><p>₱987</p></div>
        ...
        <div class="card staff-table">
          ...
          <div class="table-wrapper">
            <table>
              <thead>
                <tr><th>Name</th><th>Request</th><th>Status</th></tr>
              </thead>
              <tbody>
                <tr><td>John Doe</td><td>New Monitor</td><td><span class="status pending">Pending</span></td></tr>
                <tr><td>Jane Smith</td><td>Office Chair</td><td><span class="status approved">Approved</span></td></tr>
                <tr><td>Kevin Cruz</td><td>Mouse</td><td><span class="status rejected">Rejected</span></td></tr>
                <tr><td>Anne Tan</td><td>Laptop</td><td><span class="status approved">Approved</span></td></tr>
              </tbody>
            </table>
          </div>
        </div>
